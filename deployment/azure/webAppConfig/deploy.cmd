...
IF NOT EXIST "%DEPLOYMENT_TARGET%\env" (
  ...
  D:\home\python364x64\python.exe -m virtualenv %DEPLOYMENT_TARGET%\env
)
  
:: 3. Install packages
echo Pip install requirements Gary.
pushd "%DEPLOYMENT_TARGET%"
echo CD is %CD%
%DEPLOYMENT_TARGET%\env\Scripts\python.exe -m pip install --upgrade -r requirements.txt
IF !ERRORLEVEL! NEQ 0 goto error
